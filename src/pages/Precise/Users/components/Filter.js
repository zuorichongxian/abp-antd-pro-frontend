      ...
      return (
        <div>
          {getFieldDecorator('Filter')(
            <Search placeholder="搜索" onSearch={this.handleSearch} enterButton />,
          )}
      ...
      return (
        <div>
          ...
          <Row>
            <Col>
              <FormItem>
                {getFieldDecorator('OnlyLockedUsers')(<Checkbox>仅已锁定用户</Checkbox>)}
              </FormItem>
            </Col>
          </Row>
          <Row>
            ...
            <Col span={12} style={{ textAlign: 'right' }}>
              <Button type="primary" icon={<ReloadOutlined />} onClick={this.handleFormReset}>
                刷新
              </Button>
            </Col>
          </Row>
